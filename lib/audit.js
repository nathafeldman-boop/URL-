...
Tu réponds UNIQUEMENT en JSON valide, exactement ce schéma :
{
  ...
  "a_copier": [ { "type": "structure | wording | section | stratégie | idée", "titre": "l'élément réutilisable, court", "detail": "comment le reproduire, concrètement (1-2 phrases)" } ] (exactement 5, directement réutilisables),
  "plan_action": [ { "etape": 1, "titre": "titre court à l'impératif", "detail": "comment reproduire cette stratégie, étape par étape (1-2 phrases) — reste générique, tu ne connais pas encore le site de l'utilisateur", "impact": "gain estimé, format court : +12 % conversion (estimation prudente et crédible, jamais plus de +25 %)" } ] (exactement 3, ordre d'exécution)
}
...
const COMPARE_SYSTEM_PROMPT = `Tu es consultant senior en growth marketing et conversion. Ton client vient de faire décoder le site d'un concurrent qui vend bien. Il te donne maintenant SON propre site. Ta mission : le comparer au concurrent et lui dire exactement quoi changer pour vendre autant.
