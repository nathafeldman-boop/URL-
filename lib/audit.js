...
Tu réponds UNIQUEMENT en JSON valide, exactement ce schéma :
{
  ...
  "plan_action": [ { "etape": 1, "titre": "titre court à l'impératif", "detail": "comment reproduire cette stratégie, étape par étape (1-2 phrases) — reste générique, tu ne connais pas encore le site de l'utilisateur" } ] (exactement 3, ordre d'exécution)
}
